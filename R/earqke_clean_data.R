...
#'
#' # Piping a DataFrame.
#' any_dataframe %>% earqke_clean_data()
#'
#' # Assigning a file_name
#' earqke_clean_data(file_name = "my_folder/signif.txt")}
#'
#' @export
earqke_clean_data <- function(file_name = rlang::.data) {

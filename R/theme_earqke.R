...
#'
#' \dontrun{
#' ## Full example of geom_timeline using earqke_clean_data function to load the raw data and clean it.
#'
#' # Loading and cleaning. Later subsetting the data.
#' df_earth <- earqke_clean_data(file_name = 'inst/extdata/signif.txt') %>%
